...
| `gp/spark` | the physics-informed pairwise radial-kinetic candidate |
...
The code, tests, and docs in this repository are generated by LLM research agents to investigate
